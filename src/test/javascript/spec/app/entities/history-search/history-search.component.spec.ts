...
import { HistorySearchComponent } from 'app/entities/history-search/history-search.component';
...
describe('Component Tests', () => {
  describe('HistorySearch Management Component', () => {
    let comp: HistorySearchComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(HistorySearchComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.historySearches[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
