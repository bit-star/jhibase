...
/**
 * REST controller for managing {@link com.lazulite.base.domain.ProcessMsgTask}.
 */
@RestController
@RequestMapping("/api")
public class ProcessMsgTaskResource {
    ...
    public List<ProcessMsgTask> getAllProcessMsgTasks() {
        log.debug("REST request to get all ProcessMsgTasks");
        return processMsgTaskService.findAll();
    }
