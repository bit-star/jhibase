...
public class LocationDTO implements Serializable {
    ...
    public LocationDTO stationId(Long stationId) {
    ...
    public LocationDTO groupName(String groupName) {
    ...
    public LocationDTO stationName(String stationName) {
    ...
    public LocationDTO longitude(BigDecimal longitude) {
    ...
    public LocationDTO latitude(BigDecimal latitude) {
    ...
    public LocationDTO accuracy(String accuracy) {
    ...
    public LocationDTO province(String province) {
    ...
    public LocationDTO district(String district) {
    ...
    public LocationDTO road(String road) {
        this.road = road;
        return this;
    }
    ...
    public LocationDTO netType(String netType) {
    ...
    public LocationDTO operatorType(String operatorType) {
    ...
    public LocationDTO ddUserName(String ddUserName) {
    ...
    public LocationDTO ddUserId(Long ddUserId) {
    ...
    public LocationDTO ddUserPhone(String ddUserPhone) {
    ...
    public LocationDTO isFinish(Boolean isFinish) {
    ...
    public LocationDTO workLogMainId(Long workLogMainId) {
    ...
    public LocationDTO workLogType(WorkLogType workLogType) {
    ...
    public LocationDTO createdDate(Instant createdDate) {
